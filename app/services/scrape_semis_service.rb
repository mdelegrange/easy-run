class ScrapeSemisService
  def call
    semi_urls = 'http://bases.athle.com/asp.net/liste.aspx?frmpostback=true&frmbase=calendrier&frmmode=1&frmespace=0&frmsaison=2019&frmtype1=Hors+Stade&frmtype2=&frmtype3=HS+-+Semi-marathon&frmtype4=&frmniveau=&frmniveaulab=&frmligue=&frmdepartement=&frmepreuve=&frmdate_j1=1&frmdate_m1=1&frmdate_a1=2019&frmdate_j2=31&frmdate_m2=12&frmdate_a2=2019'

    doc = Nokogiri::HTML(open(semi_urls).read)
